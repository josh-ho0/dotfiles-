...
eval "$(rbenv init -)"
# keep this on the top, we had issues gem install rails with permission errors

# If you come from bash you might have to change your $PATH.
# export PATH=$HOME/bin:/usr/local/bin:$PATH

# Path to your oh-my-zsh installation.
export ZSH=/Users/joshho/.oh-my-zsh
...
plugins=(git bundler ruby rake rbenv zeus jump)
